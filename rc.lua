...
mytextclock = wibox.widget.textclock(" %l:%M:%p / %d-%b-%a ", 60)
...
-- Launch Firefox
        ...
        end, { description = "launch firefox", group = "browser" }),
...
-- Launch thunar
        ...
        end, { description = "launch thunar", group = "custom" }),
-- ScreenShot
        awful.key({}, "Print", function()
            awful.util.spawn("scrot -e 'mv $f ~/Screenshots/ 2>/dev/null'", false)
        end, { description = "take screenshots", group = "custom" }),
-- Screenshots by selecting area
        awful.key({ "Shift" }, "Print", function()
            awful.util.spawn("scrot -s -e 'mv $f ~/Screenshots/ 2>/dev/null'", false)
        end, { description = "take screenshots by selecting area", group = "custom" }),
-- lockscreen
...
-- launch copyq window
        ...
        end, { description = "open copyq window", group = "custom" }),
-- Brightness
